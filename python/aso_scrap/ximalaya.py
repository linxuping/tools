...
urls = ["http://www.ximalaya.com/12495477/album/4633831"]
...
doc=get_doc("http://www.ximalaya.com/12495477/album/4633831")
...
for url in urls:
	...
	for ret in doc.find_all('a',class_='title'):
		...
		print voice
		doc2=get_doc('http://m.ximalaya.com/tracks/%s.json'%voice)
		if 'play_path' in doc2:
			print doc2.split('"play_path":"')[1].split('"',2)[0]
