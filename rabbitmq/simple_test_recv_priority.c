...
#define QUEUE_ITEM_BODY_SIZE  4096
...
void copy_body(amqp_connection_state_t conn, char *buf)
{
	...
	if (body_remaining > QUEUE_ITEM_BODY_SIZE)
	...
	while (body_remaining) {
		...
		//strcat(buf, (char*)frame.payload.body_fragment.bytes); //abort ?
